 ...
 * @version 1.0
 */
public class Kafka2KafkaDataTranPlugin  extends Kafka2InputPlugin implements DataTranPlugin, KafkaSend {
	...
	public Kafka2KafkaDataTranPlugin(ImportContext importContext, ImportContext targetImportContext){
