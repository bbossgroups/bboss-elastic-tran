...
public class ExcelFileTransfer extends FileTransfer {
	...
	public ExcelFileTransfer(String taskInfo, ExcelFileOutputConfig excelFileOutputConfig, String dir, String filePath) throws IOException {
		super( taskInfo, excelFileOutputConfig,  dir,  filePath);
