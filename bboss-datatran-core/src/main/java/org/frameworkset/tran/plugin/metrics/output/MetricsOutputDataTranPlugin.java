...
public class MetricsOutputDataTranPlugin extends BasePlugin implements OutputPlugin {
	...
	public void stopCollectData(){
		List<ETLMetrics> etlMetrics = metricsOutputConfig.getMetrics();
	...
	public BaseDataTran createBaseDataTran(TaskContext taskContext, TranResultSet tranResultSet, JobCountDownLatch countDownLatch, Status currentStatus){
		MetricsOutputDataTran metricsOutputDataTran = new MetricsOutputDataTran(taskContext, tranResultSet, importContext,  currentStatus,countDownLatch);
		metricsOutputDataTran.initTran();
