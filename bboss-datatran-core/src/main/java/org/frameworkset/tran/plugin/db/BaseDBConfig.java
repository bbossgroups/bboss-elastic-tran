...
public abstract class BaseDBConfig extends BaseConfig {
	...
	public BaseDBConfig setColumnLableUpperCase(boolean columnLableUpperCase) {
		_setColumnLableUpperCase(columnLableUpperCase);
		return this;
	}

	public BaseDBConfig setDbInitSize(int dbInitSize) {
		_setDbInitSize( dbInitSize);
		return this;
	}
	public BaseDBConfig setDbMaxSize(int dbMaxSize) {
		_setDbMaxSize(  dbMaxSize);
		return this;
	}
	public BaseDBConfig setDbMinIdleSize(int dbMinIdleSize) {
	...
	public BaseDBConfig setDbDriver(String dbDriver) {
		_setDbDriver(  dbDriver);
		return this;
	}
	public BaseDBConfig setEnableDBTransaction(boolean enableDBTransaction) {
		_setEnableDBTransaction(  enableDBTransaction);
		return this;
	}


	public BaseDBConfig setDbUrl(String dbUrl) {
		_setDbUrl( dbUrl);
		return this;
	}

	public BaseDBConfig setDbAdaptor(String dbAdaptor) {
		_setDbAdaptor(  dbAdaptor);
		return this;

	}

	public BaseDBConfig setDbtype(String dbtype) {
		_setDbtype(  dbtype);
		return this;
	}

	public BaseDBConfig setDbUser(String dbUser) {
		_setDbUser(  dbUser);
		return this;
	}

	public BaseDBConfig setDbPassword(String dbPassword) {
		_setDbPassword(  dbPassword);
		return this;
	}

	public BaseDBConfig setValidateSQL(String validateSQL) {
		_setValidateSQL(  validateSQL);
		return this;
	}

	public BaseDBConfig setUsePool(boolean usePool) {
		_setUsePool(  usePool);
		return this;
	}

	public BaseDBConfig setDbInfoEncryptClass(String dbInfoEncryptClass){
		_setDbInfoEncryptClass(dbInfoEncryptClass);
		return this;
	}

	public BaseDBConfig setJdbcFetchSize(Integer jdbcFetchSize) {
